...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2018 at 01:41 PM
...
(218, 'ala bala', 'unirii 24', 720165284),
(217, 'test test', 'unirii 24', 720165284),
(216, 'mihai mihai', 'unirii 24', 720165284),
(219, 'elena elena', 'timisoara 20', 720165284),
(215, 'mihai mihai', 'unirii 50', 720165284);
...
(4, 'Creion', 'Creion ascutit, cu guma, corp verde, HB.', 'media/creion.jpg', '2');
...
--
ALTER TABLE `comenzi`
  MODIFY `ID_Comanda` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=220;
--
